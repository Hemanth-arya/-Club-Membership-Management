                            ...
                            <div class="  md:w-1/2 overflow-hidden ">
                                <div class="flex flex-col items-center justify-center text-stone-400">
                                    ...
                                    <div class="flex flex-col ">
                                        ...
                                        <input class="border-b m-2  bg-gray-50 focus:outline-none" type="text" id="username" name="username" />
    
                                        <div class="m-2">PASSWORD</div>
                                        <input class="border-b m-2  bg-gray-50  focus:outline-none" type="password" id="password" name="password"/>
                                        <?php
                                                if (isset($error)) {
                                                echo $error;
                                                    }
